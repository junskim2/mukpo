...
<body>
	...
	<div class="wrapper">
		...
		<section class="breadcrumb-part" data-stellar-offset-parent="true"
			...
			<!--혼잡도표시 끝 -->
			<!--날짜 검색 -->
		<div class="col-md-6 col-sm-6 col-xs-12" style="margin-left:20%; margin-right:20%; width:60%;">
           <input type="text" name="txt" placeholder="날짜 검색" class="date-pick"/>
        </div>
        	<!--날짜 검색 끝-->
        	<!--예약 테이블 선택  -->
        	<div class="StoreMdetail_tablechoice col-md-6 col-sm-6 col-xs-12">
        	<input type="button" value="테이블예시"><input type="button"/><input type="button" /><br/>
        	<input type="button"/><input type="button"/><input type="button" /><br/>
        	<input type="button"/><input type="button"/><input type="button" /><br/>
        	<input type="button"/><input type="button"/><input type="button" /><br/>      	
        	</div>
        	<!--예약 테이블 선택 끝  -->
